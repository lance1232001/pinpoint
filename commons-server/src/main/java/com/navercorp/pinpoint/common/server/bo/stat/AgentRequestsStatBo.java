...
public class AgentRequestsStatBo implements AgentStatDataPoint {
    ...
    public void put(String url, int status, long startTime, long elpasedTime) {
        AgentRequestsStatDataPoint requestsStatDataPoint = requestsStatDataPointMap.get(url);
        if (requestsStatDataPoint == null) {
            requestsStatDataPoint = new AgentRequestsStatDataPoint(url);
            requestsStatDataPointMap.put(url, requestsStatDataPoint);
        }

        requestsStatDataPoint.addEachRequest(status, startTime, elpasedTime);
    }
