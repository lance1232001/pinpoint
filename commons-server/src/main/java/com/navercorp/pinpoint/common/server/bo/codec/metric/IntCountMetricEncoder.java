 ...
 */
@Component
public class IntCountMetricEncoder extends AgentStatEncoder<IntCountMetricListBo> {

    @Autowired
    public IntCountMetricEncoder(@Qualifier("intCountMetricCodec") AgentStatCodec<IntCountMetricListBo> codec) {
        super(codec);
    }
