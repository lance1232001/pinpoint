...
public abstract class CustomMetricListBo<T extends CustomMetricBo> implements AgentStatDataPointList<T> {
    ...
    public boolean add(T element) {
        if (customMetricBoList.isEmpty()) {
            this.agentId = element.getAgentId();
            this.startTimestamp = element.getStartTimestamp();
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("CustomMetricListBo{");
        sb.append("name='").append(name).append('\'');
        sb.append(", customMetricBoList=").append(customMetricBoList);
