...
public class AnnotatedInterceptorFactoryTest {
    ...
    private final UrlMappingExtractorParameterValueProviderRegistry urlMappingExtractorParameterValueProviderRegistry = mock(UrlMappingExtractorParameterValueProviderRegistry.class);
    private final RequestStatMonitorFactory requestStatMonitorFactory = mock(RequestStatMonitorFactory.class);
    ...
    private AnnotatedInterceptorFactory newAnnotatedInterceptorFactory() {
        return new AnnotatedInterceptorFactory(profilerConfig, traceContext, dataSourceMonitorRegistry, apiMetaDataService, pluginContext, exceptionHandlerFactory, requestRecorderFactory,
                urlMappingExtractorParameterValueProviderRegistry, requestStatMonitorFactory);
    }
