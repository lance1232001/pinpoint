 ...
 * @author Taejin Koo
 */
public class IntGaugeMetricWrapper extends AbstractCustomMetricWrapper<IntGaugeMetric> implements IntGaugeMetric {

    public IntGaugeMetricWrapper(int id, IntGaugeMetric customMetric) {
