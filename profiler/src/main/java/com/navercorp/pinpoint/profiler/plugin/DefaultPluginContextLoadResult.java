...
public class DefaultPluginContextLoadResult implements PluginContextLoadResult {
    ...
    public List<UrlMappingExtractorParameterValueProvider> getUrlMappingExtractorParameterValueProviderList() {
        ...
        for (PluginSetupResult context : pluginsSetupResult.getPluginSetupResults()) {
            List<UrlMappingExtractorParameterValueProvider> urlMappingExtractorParameterValueProviderList = context.getUrlMappingExtractorParameterValueProviderList();
            result.addAll(urlMappingExtractorParameterValueProviderList);
        }
