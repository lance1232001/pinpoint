...
public class CustomMetricWrapperFactory {
    ...
    Class<IntCountMetricWrapper> getMappingClazz(IntCountMetric customMetric) {
        return IntCountMetricWrapper.class;
    }

    Class<LongCountMetricWrapper> getMappingClazz(LongCountMetric customMetric) {
        return LongCountMetricWrapper.class;
    }

    Class<IntGaugeMetricWrapper> getMappingClazz(IntGaugeMetric customMetric) {
        return IntGaugeMetricWrapper.class;
    }

    Class<LongGaugeMetricWrapper> getMappingClazz(LongGaugeMetric customMetric) {
        return LongGaugeMetricWrapper.class;
    }

    Class<DoubleGaugeMetricWrapper> getMappingClazz(DoubleGaugeMetric customMetric) {
        return DoubleGaugeMetricWrapper.class;
    }
