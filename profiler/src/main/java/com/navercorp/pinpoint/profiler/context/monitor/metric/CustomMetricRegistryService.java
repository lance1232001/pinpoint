...
public interface CustomMetricRegistryService {
    ...
    List<IntCountMetricWrapper> getIntCountMetricWrapperList();

    List<LongCountMetricWrapper> getLongCountMetricWrapperList();

    List<IntGaugeMetricWrapper> getIntGaugeMetricWrapperList();

    List<LongGaugeMetricWrapper> getLongGaugeMetricWrapperList();

    List<DoubleGaugeMetricWrapper> getDoubleGaugeMetricWrapperList();
