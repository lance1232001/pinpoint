 ...
 * @author Taejin Koo
 */
public class DoubleGaugeMetricWrapper extends AbstractCustomMetricWrapper<DoubleGaugeMetric> implements DoubleGaugeMetric {

    public DoubleGaugeMetricWrapper(int id, DoubleGaugeMetric customMetric) {
