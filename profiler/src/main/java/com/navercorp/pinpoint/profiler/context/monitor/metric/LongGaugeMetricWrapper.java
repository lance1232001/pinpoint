 ...
 * @author Taejin Koo
 */
public class LongGaugeMetricWrapper extends AbstractCustomMetricWrapper<LongGaugeMetric> implements LongGaugeMetric {

    public LongGaugeMetricWrapper(int id, LongGaugeMetric customMetric) {
