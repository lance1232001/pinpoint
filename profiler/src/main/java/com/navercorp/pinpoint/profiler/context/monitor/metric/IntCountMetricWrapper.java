 ...
 * @author Taejin Koo
 */
public class IntCountMetricWrapper extends AbstractCustomMetricWrapper<IntCountMetric> implements IntCountMetric {

    public IntCountMetricWrapper(int id, IntCountMetric customMetric) {
