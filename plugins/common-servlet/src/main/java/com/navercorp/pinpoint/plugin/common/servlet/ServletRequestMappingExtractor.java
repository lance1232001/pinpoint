 ...
 * @author Taejin Koo
 */
public interface ServletRequestMappingExtractor extends UrlMappingExtractor<HttpServletRequest> {

    UrlMappingExtractorType TYPE = UrlMappingExtractorType.SERVLET_REQUEST_ATTRIBUTE;
